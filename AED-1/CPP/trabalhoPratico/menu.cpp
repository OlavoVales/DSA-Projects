...
// a função responsável por exibir o menu
...
//a função responsavel por posibilitar a escolha de qual outra funcao deseja ser selecionada.
    ...
    do {
        ...
        switch (opcao) {
            ...
            case 8:
                ...
                break;
            default:
                std::cout << "Opcaoo invalida! Tente novamente.\n";
        }
